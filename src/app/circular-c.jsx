...
function CircularC({ defaults, fors }) {
    ...
    const handleChange = (value, index) => {
        ...
        outTemp[0] = Number(inTemp[2] - (inTemp[1] * (1.2 - 0.3 * (inTemp[0] / defaults[3])))).toFixed(2)
        outTemp[1] = '-'
    ...
    return (
        <Card style={{ marginRight: '1rem' }}>
            <CardHeader>
                <Heading size='md'>CASO C: Descenso normal</Heading>
            </CardHeader>
            ...
            <CardBody>
                <Stack divider={<StackDivider />} spacing='4'>
                    ...
                    <Box>
                        <Image src={Imagen22} alt='img5' width='800px' />
                    </Box>
                </Stack>
            </CardBody>
        </Card>
